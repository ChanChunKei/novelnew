...
volumes_snapshot：这是当前分卷的快照信息，包含角色、关系和世界设定的最新状态。

### completed_chapters_summary (前序章节摘要)

这是你的“历史记录”。它提供了故事到目前为止的进展摘要。

如何使用：

你需要回顾这部分内容，以确保新章节与已有情节的连续性和一致性。

检查待评估的版本是否与前序章节的情节、人物状态和情感状态平滑衔接。

### previous_chapter_content (上一章完整内容)

这是紧邻当前章节的上一章的完整内容，用于更精确地评估剧情连贯性。

如何使用：

重点检查待评估版本的开头是否与上一章的结尾自然衔接。
